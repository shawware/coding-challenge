...
class ValidatorUnitTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Exercises Validator->validateNotNull()
	 *
	 * @dataProvider nullFixture
     */
    ...
    {
        return array(
                array('okay', 'test 1', true),
                array('', 'test 2', true),
                array(3, 'test 3', true),
                array(null, 'test 4', false) 
        );
    }

    /**
     * Exercises Validator->validateString()
	 *
	 * @dataProvider stringFixture
     */
    public function testString($param, $name, $valid)
    {
        try {
    ...
    public function stringFixture()
    {
        return array(
                array('okay', 'test 1', true),
                array('', 'test 2', false),
                array(3, 'test 3', false),
                array(null, 'test 4', false) 
        );
    }

    /**
     * Exercises Validator->validateArray()
	 *
	 * @dataProvider arrayFixture
     */
    ...
    {
        return array(
                array(null, 'test 1', false, false),
                array(array(), 'test 2a', false, false),
                array(array(), 'test 2b', true, true),
                array(new \stdClass(), 'test 3', false, false),
                array('hello', 'test 4', false, false),
                array(3, 'test 5', false, false),
                array(array('hello', 3), 'test 6a', false, true),
                array(array('hello', 3), 'test 6a', true, true) 
        );
    }

    /**
     * Exercises Validator->validateStringArray()
	 *
	 * @dataProvider stringArrayFixture
     */
    ...
    {
        return array(
                array(array('okay'), 'test 1a', false, true),
                array(array('okay'), 'test 1b', false, true),
                array(array('okay'), 'test 2', false, true),
                array(array('okay', ''), 'test 3', false, false),
                array(array('okay', null), 'test 4', false, false),
                array(array('okay', 'ok', 'nice', 'sweet'), 'test 5a', false, true),
                array(array('okay', 'ok', 'nice', 'sweet'), 'test 5b', true, true),
                array(array('okay', 'ok', 3, 'sweet'), 'test 6', false, false),
                array(array('okay', 'ok', 'nice', true), 'test 7', false, false) 
        );
    }

    /**
     * Exercises Validator->validateTypedArray()
	 *
	 * @dataProvider typedArrayFixture
     */
    ...
    public function typedArrayFixture()
    {
        $v = new Validator();
        return array(
                array(array(), 'string', 'test 1a', false, false),
                array(array(), 'string', 'test 1b', true, true),
                array(array(''), 'string', 'test 2', false, true),
                array(array('okay'), 'string', 'test 3a', false, true),
                array(array('okay'), 'string', 'test 3b', true, true),
                array(array('okay', ''), 'string', 'test 4', false, true),
                array(array('okay', null), 'string', 'test 5', false, false),
                array(array(1, 2, 3), 'string', 'test 6', false, false),
                array(array(1, 2, 3), 'integer', 'test 7a', false, true),
                array(array(1, 2, 3), 'integer', 'test 7b', true, true),
                array(array($v), 'Shawware\CodingChallenge\Util\Validator', 'test 8', false, true ) 
        );
    }
}
